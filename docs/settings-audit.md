...
| `panelAutoRefresh` | panel | - | - | **PANEL-READ** | - | web/app.js:2511 | - |
...
| `device` | model | - | - | **OK** | app/api.py:158<br>app/api.py:554<br>app/assistant.py:306<br>app/boot.py:296 | web/app.js:1915<br>web/app.js:1950 | - |
| `meetingDiarize` | model | - | - | **OK** | app/meeting.py:158<br>app/meeting.py:463 | web/app.js:1951 | - |
| `meetingSttModel` | model | - | - | **OK** | app/meeting.py:154<br>app/meeting.py:351<br>app/meeting.py:456<br>mac/run_mac.py:36 | web/app.js:1296<br>web/app.js:1911<br>web/app.js:1948 | - |
| `sttModel` | model | - | - | **OK** | app/assistant.py:297<br>app/meeting.py:167<br>app/meeting.py:456<br>app/meeting.py:523 | web/app.js:1295<br>web/app.js:1911<br>web/app.js:1947 | - |
| `voiceprintAutoEnroll` | model | - | - | **OK** | app/voiceprint.py:49 | web/app.js:1988 | - |
| `voiceprintEnabled` | model | - | - | **OK** | app/voiceprint.py:44 | web/app.js:1971<br>web/app.js:1987 | - |
| `voiceprintMargin` | model | - | - | **OK** | app/voiceprint.py:59 | web/app.js:1990 | - |
| `voiceprintThreshold` | model | - | - | **OK** | app/voiceprint.py:55 | web/app.js:1989 | - |
| `wakeEngine` | model | - | - | **OK** | app/audio/wake.py:43<br>app/audio/wake.py:203 | web/app.js:1916<br>web/app.js:1949 | - |
| `apiAuthEnabled` | panel | - | - | **OK** | app/api.py:50 | web/app.js:2147 | - |
...
| `commandTargetSession` | voice | command | - | **OK** | app/assistant.py:401 | web/app.js:768 | - |
| `commandTargetWorkspace` | voice | command | - | **OK** | app/assistant.py:400 | web/app.js:767 | - |
...
| `ttsEngine` | voice | speech | - | **OK** | app/boot.py:343<br>app/config.py:549<br>app/providers/__init__.py:144 | web/app.js:1094<br>web/app.js:1217<br>web/app.js:1259 | - |
