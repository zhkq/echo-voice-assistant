...
| `capabilityPrivacy` | capability | - | hidden | **OK-INDIRECT** | - | - | - |
...
| `panelAutoRefresh` | panel | - | - | **PANEL-READ** | - | web/app.js:3539 | - |
...
| `device` | model | - | - | **OK** | app/api.py:176<br>app/api.py:637<br>app/assistant.py:362<br>app/boot.py:501 | web/app.js:2311<br>web/app.js:2363 | - |
| `meetingDiarize` | model | - | - | **OK** | app/meeting.py:165<br>app/meeting.py:563 | web/app.js:2364 | - |
| `meetingSttModel` | model | - | - | **OK** | app/meeting.py:161<br>app/meeting.py:373<br>app/meeting.py:556<br>app/capabilities/local.py:180 | web/app.js:1673<br>web/app.js:2307<br>web/app.js:2361 | - |
| `sttModel` | model | - | - | **OK** | app/assistant.py:353<br>app/meeting.py:174<br>app/meeting.py:556<br>app/meeting.py:623 | web/app.js:1672<br>web/app.js:2307<br>web/app.js:2360 | - |
| `voiceprintAutoEnroll` | model | - | - | **OK** | app/voiceprint.py:49 | web/app.js:2401 | - |
| `voiceprintEnabled` | model | - | - | **OK** | app/voiceprint.py:44 | web/app.js:2384<br>web/app.js:2400 | - |
| `voiceprintMargin` | model | - | - | **OK** | app/voiceprint.py:59 | web/app.js:2403 | - |
| `voiceprintThreshold` | model | - | - | **OK** | app/voiceprint.py:55 | web/app.js:2402 | - |
| `wakeEngine` | model | - | - | **OK** | app/audio/wake.py:43<br>app/audio/wake.py:203 | web/app.js:2312<br>web/app.js:2362 | - |
| `apiAuthEnabled` | panel | - | - | **OK** | app/api.py:50 | web/app.js:2563 | - |
