...
| `device` | model | - | - | **OK** | app/api.py:158<br>app/api.py:554<br>app/assistant.py:306<br>app/boot.py:296 | web/app.js:1999<br>web/app.js:2034 | - |
| `meetingDiarize` | model | - | - | **OK** | app/meeting.py:158<br>app/meeting.py:463 | web/app.js:2035 | - |
| `meetingSttModel` | model | - | - | **OK** | app/meeting.py:154<br>app/meeting.py:351<br>app/meeting.py:456<br>mac/run_mac.py:36 | web/app.js:1376<br>web/app.js:1995<br>web/app.js:2032 | - |
| `sttModel` | model | - | - | **OK** | app/assistant.py:297<br>app/meeting.py:167<br>app/meeting.py:456<br>app/meeting.py:523 | web/app.js:1375<br>web/app.js:1995<br>web/app.js:2031 | - |
| `voiceprintAutoEnroll` | model | - | - | **OK** | app/voiceprint.py:49 | web/app.js:2072 | - |
| `voiceprintEnabled` | model | - | - | **OK** | app/voiceprint.py:44 | web/app.js:2055<br>web/app.js:2071 | - |
| `voiceprintMargin` | model | - | - | **OK** | app/voiceprint.py:59 | web/app.js:2074 | - |
| `voiceprintThreshold` | model | - | - | **OK** | app/voiceprint.py:55 | web/app.js:2073 | - |
| `wakeEngine` | model | - | - | **OK** | app/audio/wake.py:43<br>app/audio/wake.py:203 | web/app.js:2000<br>web/app.js:2033 | - |
| `apiAuthEnabled` | panel | - | - | **OK** | app/api.py:50 | web/app.js:2231 | - |
...
| `commandIdleRotateHours` | voice | command | - | **OK** | app/agents/dsh_agent.py:516 | - | - |
| `commandTargetSession` | voice | command | - | **OK** | app/assistant.py:401 | web/app.js:839 | - |
| `commandTargetWorkspace` | voice | command | - | **OK** | app/assistant.py:400 | web/app.js:838 | - |
| `commandWorkspace` | voice | command | - | **OK** | app/agents/dsh_agent.py:507<br>app/agents/dsh_agent.py:553 | - | - |
...
| `ttsEngine` | voice | speech | - | **OK** | app/boot.py:343<br>app/config.py:549<br>app/providers/__init__.py:144 | web/app.js:1174<br>web/app.js:1297<br>web/app.js:1339 | - |
