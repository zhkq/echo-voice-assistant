...
| `panelAutoRefresh` | panel | - | - | **PANEL-READ** | - | web/app.js:3415 | - |
| `agentBackend` | agent | - | hidden | **OK** | app/harness_proc.py:95<br>app/install_state.py:153<br>app/agents/__init__.py:128 | - | - |
...
| `device` | model | - | - | **OK** | app/api.py:158<br>app/api.py:592<br>app/assistant.py:305<br>app/boot.py:332 | web/app.js:2194<br>web/app.js:2246 | - |
| `meetingDiarize` | model | - | - | **OK** | app/meeting.py:161<br>app/meeting.py:490 | web/app.js:2247 | - |
| `meetingSttModel` | model | - | - | **OK** | app/meeting.py:157<br>app/meeting.py:378<br>app/meeting.py:483<br>mac/run_mac.py:40 | web/app.js:1556<br>web/app.js:2190<br>web/app.js:2244 | - |
| `sttModel` | model | - | - | **OK** | app/assistant.py:296<br>app/meeting.py:170<br>app/meeting.py:483<br>app/meeting.py:550 | web/app.js:1555<br>web/app.js:2190<br>web/app.js:2243 | - |
| `voiceprintAutoEnroll` | model | - | - | **OK** | app/voiceprint.py:49 | web/app.js:2284 | - |
| `voiceprintEnabled` | model | - | - | **OK** | app/voiceprint.py:44 | web/app.js:2267<br>web/app.js:2283 | - |
| `voiceprintMargin` | model | - | - | **OK** | app/voiceprint.py:59 | web/app.js:2286 | - |
| `voiceprintThreshold` | model | - | - | **OK** | app/voiceprint.py:55 | web/app.js:2285 | - |
| `wakeEngine` | model | - | - | **OK** | app/audio/wake.py:43<br>app/audio/wake.py:203 | web/app.js:2195<br>web/app.js:2245 | - |
| `apiAuthEnabled` | panel | - | - | **OK** | app/api.py:50 | web/app.js:2444 | - |
...
| `commandTargetSession` | voice | command | - | **OK** | app/assistant.py:400 | web/app.js:947 | - |
| `commandTargetWorkspace` | voice | command | - | **OK** | app/assistant.py:399 | web/app.js:946 | - |
...
| `inputDeviceId` | voice | record | - | **OK** | app/api.py:1263<br>app/assistant.py:327<br>app/assistant.py:336<br>app/meeting.py:176 | - | - |
...
| `ttsEngine` | voice | speech | - | **OK** | app/boot.py:379<br>app/config.py:575<br>app/providers/__init__.py:144 | web/app.js:1323<br>web/app.js:1477<br>web/app.js:1519 | - |
...
| `wakeEnabled` | wake | - | - | **OK** | app/boot.py:397<br>app/install_state.py:152<br>app/runtime.py:270<br>app/settings_effects.py:53 | - | - |
