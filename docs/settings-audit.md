...
| `panelAutoRefresh` | panel | - | - | **PANEL-READ** | - | web/app.js:2319 | - |
...
| `device` | model | - | - | **OK** | app/api.py:158<br>app/api.py:554<br>app/assistant.py:306<br>app/boot.py:296 | web/app.js:1630<br>web/app.js:1665 | - |
| `meetingDiarize` | model | - | - | **OK** | app/meeting.py:158<br>app/meeting.py:463 | web/app.js:1666 | - |
| `meetingSttModel` | model | - | - | **OK** | app/meeting.py:154<br>app/meeting.py:351<br>app/meeting.py:456<br>mac/run_mac.py:36 | web/app.js:1626<br>web/app.js:1663 | - |
| `sttModel` | model | - | - | **OK** | app/assistant.py:297<br>app/meeting.py:167<br>app/meeting.py:456<br>app/meeting.py:523 | web/app.js:1626<br>web/app.js:1662 | - |
| `voiceprintAutoEnroll` | model | - | - | **OK** | app/voiceprint.py:49 | web/app.js:1716 | - |
| `voiceprintEnabled` | model | - | - | **OK** | app/voiceprint.py:44 | web/app.js:1686<br>web/app.js:1715 | - |
| `voiceprintMargin` | model | - | - | **OK** | app/voiceprint.py:59 | web/app.js:1718 | - |
| `voiceprintThreshold` | model | - | - | **OK** | app/voiceprint.py:55 | web/app.js:1717 | - |
| `wakeEngine` | model | - | - | **OK** | app/audio/wake.py:43<br>app/audio/wake.py:203 | web/app.js:1631<br>web/app.js:1664 | - |
| `apiAuthEnabled` | panel | - | - | **OK** | app/api.py:50 | web/app.js:1955 | - |
...
| `ttsEngine` | voice | speech | - | **OK** | app/boot.py:343<br>app/config.py:542<br>app/providers/__init__.py:144 | - | - |
