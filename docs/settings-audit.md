...
| `fallbackHotkey` | voice | - | **OK-INDIRECT** | - | - | - |
| `wakeHotkey` | voice | - | **OK-INDIRECT** | - | - | - |
| `panelAutoRefresh` | panel | - | **PANEL-READ** | - | web/app.js:2247 | - |
| `agentBackend` | agent | hidden | **OK** | app/agents/__init__.py:127 | - | - |
| `agentCustomPath` | agent | hidden | **OK** | app/agents/codebuddy.py:50 | web/app.js:945 | - |
| `beepOnDone` | beep | - | **OK** | app/assistant.py:333 | - | - |
| `beepOnSend` | beep | - | **OK** | app/assistant.py:504 | - | - |
| `beepOnStart` | beep | - | **OK** | app/assistant.py:317 | - | - |
| `notifyOnSend` | beep | - | **OK** | app/assistant.py:340<br>app/assistant.py:462<br>app/assistant.py:506 | - | - |
| `commandIdleRotateHours` | command | - | **OK** | app/agents/dsh_agent.py:514 | - | - |
| `commandTargetSession` | command | - | **OK** | app/assistant.py:401 | web/app.js:768 | - |
| `commandTargetWorkspace` | command | - | **OK** | app/assistant.py:400 | web/app.js:767 | - |
| `commandWorkspace` | command | - | **OK** | app/agents/dsh_agent.py:505<br>app/agents/dsh_agent.py:551 | - | - |
| `sendEnvContext` | command | - | **OK** | app/assistant.py:102 | - | - |
| `userLocation` | command | - | **OK** | app/assistant.py:107 | - | - |
...
| `device` | model | - | **OK** | app/api.py:158<br>app/api.py:554<br>app/assistant.py:306<br>app/boot.py:296 | web/app.js:1558<br>web/app.js:1593 | - |
| `meetingDiarize` | model | - | **OK** | app/meeting.py:158<br>app/meeting.py:463 | web/app.js:1594 | - |
| `meetingSttModel` | model | - | **OK** | app/meeting.py:154<br>app/meeting.py:351<br>app/meeting.py:456<br>mac/run_mac.py:36 | web/app.js:1554<br>web/app.js:1591 | - |
| `sttModel` | model | - | **OK** | app/assistant.py:297<br>app/meeting.py:167<br>app/meeting.py:456<br>app/meeting.py:523 | web/app.js:1554<br>web/app.js:1590 | - |
| `voiceprintAutoEnroll` | model | - | **OK** | app/voiceprint.py:49 | web/app.js:1644 | - |
| `voiceprintEnabled` | model | - | **OK** | app/voiceprint.py:44 | web/app.js:1614<br>web/app.js:1643 | - |
| `voiceprintMargin` | model | - | **OK** | app/voiceprint.py:59 | web/app.js:1646 | - |
| `voiceprintThreshold` | model | - | **OK** | app/voiceprint.py:55 | web/app.js:1645 | - |
| `wakeEngine` | model | - | **OK** | app/audio/wake.py:43<br>app/audio/wake.py:203 | web/app.js:1559<br>web/app.js:1592 | - |
| `apiAuthEnabled` | panel | - | **OK** | app/api.py:50 | web/app.js:1883 | - |
...
| `maxBriefChars` | speech | - | **OK** | app/assistant.py:513 | - | - |
| `minimalReply` | speech | - | **OK** | app/assistant.py:121 | - | - |
| `minimalReplyChars` | speech | - | **OK** | app/assistant.py:127<br>app/assistant.py:496 | - | - |
| `minimalReplyHint` | speech | - | **OK** | app/assistant.py:123 | - | - |
| `ttsEngine` | speech | - | **OK** | app/boot.py:343<br>app/config.py:532<br>app/providers/__init__.py:144 | - | - |
| `voiceBrief` | speech | - | **OK** | app/assistant.py:518 | - | - |
| `voiceConfirm` | speech | - | **OK** | app/assistant.py:367 | - | - |
| `consumeMediaKey` | voice | - | **OK** | app/platform/win32/hotkey.py:148 | - | - |
| `inputDeviceId` | voice | - | **OK** | app/api.py:1084<br>app/assistant.py:328<br>app/assistant.py:337<br>app/meeting.py:173 | - | - |
| `maxRecordMs` | voice | - | **OK** | app/assistant.py:324 | - | - |
| `noSpeechAbortMs` | voice | - | **OK** | app/assistant.py:327 | - | - |
| `silenceHangoverMs` | voice | - | **OK** | app/assistant.py:326 | - | - |
| `silenceThreshold` | voice | - | **OK** | app/assistant.py:325<br>app/assistant.py:338 | - | - |
| `sttLanguage` | voice | - | **OK** | app/assistant.py:289<br>app/assistant.py:305<br>app/meeting.py:390<br>app/meeting.py:458 | - | - |
| `triggerKeys` | voice | - | **OK** | app/runtime.py:215<br>mac/mac_runtime.py:134 | - | - |
